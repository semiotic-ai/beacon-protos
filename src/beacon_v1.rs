...
impl<E: EthSpec> TryFrom<Attestation> for types::AttestationBase<E> {
    ...
    fn try_from(
        ...
        Ok(Self {
            ...
            data: data
                .ok_or(BeaconProtosError::AttestationDataMissing)?
                .try_into()?,
...
impl<E: EthSpec> TryFrom<AttesterSlashing> for types::AttesterSlashingBase<E> {
    ...
    fn try_from(
        ...
        let attestation_1 = attestation_1.ok_or(BeaconProtosError::SignerMissing)?;
        let attestation_2 = attestation_2.ok_or(BeaconProtosError::SignerMissing)?;
...
impl<E: EthSpec> TryFrom<IndexedAttestation> for types::IndexedAttestationBase<E> {
    ...
    fn try_from(
        ...
        Ok(IndexedAttestationBase {
            ...
            data: data
                .ok_or(BeaconProtosError::IndexedAttestationDataMissing)?
                .try_into()?,
            signature: bls::generics::GenericAggregateSignature::deserialize(signature.as_slice())
                .map_err(|e| BeaconProtosError::Bls(format!("{:?}", e)))?,
        })
    ...
    fn try_from(
        ...
        Ok(Self {
            signed_header_1: signed_header_1
                .ok_or(BeaconProtosError::SignerMissing)?
                .try_into()?,
...
impl TryFrom<SignedBeaconBlockHeader> for types::SignedBeaconBlockHeader {
    ...
    fn try_from(
        ...
        Ok(Self {
            message: message
                .ok_or(BeaconProtosError::SignedBeaconBlockHeaderMessageMissing)?
                .into(),
...
impl TryFrom<SignedBlsToExecutionChange> for types::SignedBlsToExecutionChange {
    ...
    fn try_from(
        ...
        Ok(Self {
            message: message
                .ok_or(BeaconProtosError::BlsToExecutionChangeMissing)?
                .try_into()?,
            signature: bls::generics::GenericSignature::deserialize(signature.as_slice())
...
impl TryFrom<SignedVoluntaryExit> for types::SignedVoluntaryExit {
    ...
    fn try_from(
        ...
        Ok(Self {
            message: message
                .ok_or(BeaconProtosError::VoluntaryExitMissing)?
                .into(),
            signature: bls::generics::GenericSignature::deserialize(signature.as_slice())
                .map_err(|e| BeaconProtosError::Bls(format!("{:?}", e)))?,
        })
...
impl TryFrom<SingleBlockResponse> for Block {
    ...
    fn try_from(response: SingleBlockResponse) -> Result<Self, Self::Error> {
        let any = response
            .block
            .ok_or(BeaconProtosError::BlockMissingInResponse)?;
        ...
        let beacon_block_body = BeaconBlockBodyDeneb {
            ...
            graffiti: Graffiti::from(
                <[u8; GRAFFITI_BYTES_LEN]>::try_from(graffiti.as_slice())
                    .map_err(|_| BeaconProtosError::GraffitiInvalid)?,
            ),
            ...
            execution_payload: execution_payload
                .ok_or(BeaconProtosError::ExecutionPayloadMissing)
            ...
            blob_kzg_commitments: blob_kzg_commitments
                ...
                .map(|blob_kzg_commitment| {
                    <[u8; 48]>::try_from(blob_kzg_commitment.as_slice())
                        ...
                        .map_err(|_| BeaconProtosError::KzgCommitmentInvalid)
                })
                .collect::<Result<Vec<_>, _>>()?
                .into(),
        };
